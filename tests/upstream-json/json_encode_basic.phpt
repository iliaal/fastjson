--TEST--
Test fastjson_encode() function : basic functionality
--EXTENSIONS--
fastjson
--FILE--
<?php
echo "*** Testing fastjson_encode() : basic functionality ***\n";
...
// loop through with each element of the $inputs array to test fastjson_encode() function
$count = 1;
foreach($inputs as $input) {
    echo "-- Iteration $count --\n";
    var_dump(fastjson_encode($input));
    $count ++;
}

?>
--EXPECT--
*** Testing fastjson_encode() : basic functionality ***
-- Iteration 1 --
string(1) "0"
-- Iteration 2 --
string(3) "123"
