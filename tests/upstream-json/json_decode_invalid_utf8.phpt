--TEST--
fastjson_decode() invalid UTF8
--EXTENSIONS--
fastjson
--FILE--
<?php
function json_decode_invalid_utf8($str) {
    var_dump(fastjson_decode($str));
    var_dump(fastjson_decode($str, true, 512, JSON_INVALID_UTF8_IGNORE));
    $json = fastjson_decode($str, true, 512, JSON_INVALID_UTF8_SUBSTITUTE);
    if (is_array($json)) {
